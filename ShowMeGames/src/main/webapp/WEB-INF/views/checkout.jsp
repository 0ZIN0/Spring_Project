...
<body>
	...
	<div class="background_layer1">
		<main id="checkout-main" class="background_layer2">
					...
					<div id="nav-top">
						...
						<div id="top-cart-list">
							...
							<div class="display-none" id="checkout-cart-mid"
								...
								data-name="${cart_list[0].game_name}"
								data-email="${user.user_id}"
								data-phonenum="${user.phone_number}">
					...
					<div>
						...
						<div id="nav-grid">
							<div id="summary-grid">
								...
								<div>
									<div id="add-point" data-addpoint="${unit}">해당 구매로 획득하는
										바이트</div>
									<div class="price">

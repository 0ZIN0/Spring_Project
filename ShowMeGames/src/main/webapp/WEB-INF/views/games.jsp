		...
		<div class="background_layer2">
			...
			<div id=week-best-seller class="slider">
				<div>
					<div class="bar"></div>
					<div>
						<span class="title">큐레이터 추천</span>
					</div>
				</div>
				<div id=week-best-seller-card-container
					class="card-container curator-container">
			...
			<div id=best-seller class="slider">
				<div>
					...
					<div class="head-title">
						<span class="title">최고 인기 게임</span>
					</div>
				</div>
				<div id=best-seller-card-container
					class="card-container editer-container">
			...
			<div id=week-best-seller class="slider">
				<div>
					<div class="bar"></div>
					<div>
						<span class="title">이번주 베스트셀러</span>
					</div>
				</div>
				<div id=week-best-seller-card-container
					class="card-container editer-container">
			...
			<div id="game_list" class="grid_container">
				<div class="secondary">
					<div class="filter">
						...
						<div class="filter_content">
							...
							<ul class="filter_list">
								<li class="filter_item"><input type="checkbox"
									value="개인맞춤추천" /> <label for="">개인 맞춤 추천</label></li>
							</ul>
						</div>
						<hr />
						<div class="filter_content">
							...
							<ul class="filter_list genre-list">
								<li class="filter_item genre"><input type="checkbox"
									value="RPG" /><label for="">RPG</label></li>
								<li class="filter_item genre"><input type="checkbox"
									value="슈팅" /><label for="">슈팅</label></li>
								<li class="filter_item genre"><input type="checkbox"
									value="전략" /><label for="">전략</label></li>
								<li class="filter_item genre"><input type="checkbox"
									value="시뮬레이션" /><label for="">시뮬레이션</label></li>
								<li class="filter_item genre"><input type="checkbox"
									value="인디" /><label for="">인디</label></li>
								<li class="filter_item genre"><input type="checkbox"
									value="레이싱" /><label for="">레이싱</label></li>
								<li class="filter_item genre"><input type="checkbox"
				...
				<div class="primary">
					<div class="sort">
						<div class="sort_by">
							<span class="material-symbols-outlined"> sort </span> <label>정렬
								기준:</label>

...
<c:url value="/resources/customer/notice_detail/notice_detail.css"
	var="notice_detail_css" />
<c:url value="/resources/customer/notice_detail/notice_detail.js"
	var="notice_detail.js" />
			...
			<div id="notice_container">
				<div class="detail_header">
					<div id="detail_notice">
						<h1 style="font-size: 50px; text-align: left;">공지사항</h1>
					</div>
					<div class="board">
						<a href="../notice"> <span
				...
				<div class="top_icon">
					<div>
						<i style="font-size: 12px;" class="fa-solid fa-calendar-days">
							<fmt:formatDate pattern="yyyy년 MM월 dd일"
								value="${detail.write_date}" />
						</i>
					</div>
				</div>
				<br>
				<div>
					<img class="img"
						src="/smg/resources/img/customer/notice/${detail.banner_url}"
						alt="공지사항 이미지" />
				</div>
				<br> <br>

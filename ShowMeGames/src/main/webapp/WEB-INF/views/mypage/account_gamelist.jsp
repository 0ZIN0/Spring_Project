					...
					<div class="item_title_wrapper">
						<div id="game-list-div" class="item_title_wrapper">
							...
							<div id="game-list">
								...
								<div id="game-content">
									<c:choose>
										<c:when test="${myGameList != null and not empty myGameList }">
											<c:forEach items="${myGameList }" var="game">
												<div class="game-content-front">
													<div>
														<fmt:formatDate var="date" value="${game.order_date}"
													...
													<div>
														<button class="btn key-btn" data-key="key-${game.game_id}">키
															확인</button>
													</div>
													<div id="key-${game.game_id}" class="game-content-back">
														...
														<div>
															<button class="btn game-detail-btn"
																data-key="key-${game.game_id}">결제 내역</button>
														</div>
													</div>
												</div>
											</c:forEach>

...
next_btn.on("click", function () {
  if (!isAnimating) {
    $(this)
      .parent()
      .scrollLeft($(this).parent().scrollLeft() + 1600);
  }
});
...
$(document).on("click", ".toGenreBtn", function () {
  let id = $($(this)).data("id");
  location.href = `./games?genre=${id}#game_list`;
});
...
$(preBtn).click(function () {
  $("#genre-container").prepend(
    '<div class="genres toGenreBtn" data-id="' +
      genres[preBtnIndex].text +
      '" style="background-image: url(' +
      genres[preBtnIndex].img +
      '">' +
      "<span>" +
      genres[preBtnIndex].text +
      "</span>" +
...
$(nextBtn).click(function () {
  $("#genre-container").append(
    '<div class="genres toGenreBtn" data-id="' +
      genres[nextBtnIndex].text +
      '" style="background-image: url(' +
      genres[nextBtnIndex].img +
      '">' +
      "<span>" +
      genres[nextBtnIndex].text +
      "</span>" +
